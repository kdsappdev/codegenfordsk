...
namespace DNCCFrameWork.DataAccess
{
    ...
    {       
        ...
        public DbFactory(string connectionStringName)
        {
            ...
            BaseDbHelper baseHelper = (BaseDbHelper)Assembly.Load("CodeGenForDsk").CreateInstance("DNCCFrameWork.DataAccess.DbProvider." + DbProviderString);
        ...
        public DbFactory(string connectionString, string dbProvider)
        {
            ...
            BaseDbHelper baseHelper = (BaseDbHelper)Assembly.Load("CodeGenForDsk").CreateInstance("DNCCFrameWork.DataAccess.DbProvider." + dbProvider);
            baseHelper.ConnectionString = ConnectionString;
            IDbHelper = baseHelper;
        }
