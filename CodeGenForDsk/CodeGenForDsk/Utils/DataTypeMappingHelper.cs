...
{
    public sealed class DataTypeMappingHelper
    {
        private DataTypeMappingHelper()
        { }
        public static string GetCSharpDataTypeByDbType(string dbType, string dbDataType, string dbDataScale, string dbDataLenght)
        {
            string str = "";
            int scale = 0;
            int lenght = 0;
            ...
            {
                case "Oracle":
                    str = OracleDBForDataTypeMappingHelper.GetCSharpDataTypeByDbType(dbDataType, scale, lenght);
                    break;
                case "Sql Server":
                    str = SqlServerDBForDataTypeMappingHelper.GetCSharpDataTypeByDbType(dbDataType, scale, lenght);
                    break;
            }
            return str;
        }
    ...
    internal class OracleDBForDataTypeMappingHelper
    {
        ...
        { }
        public static string GetCSharpDataTypeByDbType(string dbDataType, int dbDataScale, int dbDataLenght)
        {
            string str = "string";
